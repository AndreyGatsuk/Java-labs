...
public final class Server {
    ...
    public static final class DefaultSimpleService extends AbstractRSocket {
        ...
        public Mono<Void> fireAndForget(Payload payload) {
            ...
            log.info("получен fireAndForget в Server");
        ...
        public Mono<Payload> requestResponse(Payload payload) {
            System.out.println(payload);
            log.info("получен requestResponse в Server");
            log.info(payload.getDataUtf8());
            Connection conn;
        ...
        public Flux<Payload> requestStream(Payload payload) {
            System.out.println(payload);
            log.info("получен requestStream в Server");
            log.info(payload.getDataUtf8());
            Connection conn;
            ...
            // Обработка запроса и формирование ответа в виде потока
            return Mono.just(payload.getDataUtf8())
                    .map(payloadString -> MessageMapper.jsonToMessage(payloadString))
        ...
        public Flux<Payload> requestChannel(Publisher<Payload> payloads) {
            ...
            log.info("получен requestChannel в Server");
            Connection conn;
